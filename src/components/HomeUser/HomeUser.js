...
function HomeUser() {
  return (
    <div>
      <HomeCarousel />
      <Card variant='outlined' sx={{border:'1px solid #4462A5', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width:'70%', margin: 'auto', marginBottom:'30px'}}>
        <Typography sx={{fontSize: '1.4rem', padding:'30px', fontFamily: 'montserrat'}}>Gestion compte personnel</Typography>
        <Account />
      </Card>
      <Button className='button'>
        <Typography sx={{fontSize: '1.4rem', padding:'20px', background:'#4462A5', color:'white', marginBottom:'30px', letterSpacing:'1px', fontFamily: 'montserrat'}}>Ajouter un compte</Typography>
      </Button>
