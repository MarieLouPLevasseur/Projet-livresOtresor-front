...
function Home() {
  return (
    <div className='home'sx={{width: '70%' , display: {xs:'flex-column', md: 'flex'} }}>
      <HomeCarousel />
      <Typography className='titre1' variant="h1" sx={{color:"#4462A5", padding: '40px'}}>Bienvenue sur le site de O'Trésor</Typography>
      <Typography className='titre2' variant="h2" sx={{paddingBottom:'40px'}}>
      ...
      />
      <Typography className='paragraphe' sx={{ padding:'44px', maxWidth: '300px'}}>
      ...
      <Typography  sx={{margin:'20px', color: '#4462A5', fontSize: '1.1rem'}}>
       Bonne lecture !
      </Typography>
